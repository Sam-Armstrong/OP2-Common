! Robustness: F2018 assumed-rank dummy argument x(..).
! fparser2 0.2.0 (std=f2008) rejects the (..) assumed-rank syntax.

module assumed_rank_helpers
    implicit none
contains
...
end module assumed_rank_helpers

program assumed_rank
    use OP2_FORTRAN_DECLARATIONS
    use OP2_FORTRAN_REFERENCE
    use, intrinsic :: ISO_C_BINDING
    use assumed_rank_helpers

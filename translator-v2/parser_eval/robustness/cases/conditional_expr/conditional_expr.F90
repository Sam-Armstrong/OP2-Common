! Robustness: F2023 conditional expression (cond ? x : y).
! fparser2 0.2.0 (std=f2008) rejects the ternary-style conditional-expr.

program conditional_expr

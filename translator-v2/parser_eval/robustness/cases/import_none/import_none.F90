! Robustness: F2018 IMPORT, NONE.
! fparser2 0.2.0 (std=f2008) rejects IMPORT, NONE / ONLY / ALL.

module import_none_helpers
    implicit none
    integer :: host_marker = 1
contains
    subroutine touch_local
        import, none
        integer :: k
        k = 0
    end subroutine touch_local
end module import_none_helpers

program import_none
    use OP2_FORTRAN_DECLARATIONS
    use OP2_FORTRAN_REFERENCE
    use, intrinsic :: ISO_C_BINDING
    use import_none_helpers

! Robustness: force Flang Stage-1 fallback via a failing --flang-scan stub.
! The source itself is ordinary OP2 Fortran that fparser2 can translate.

program stage1_scan_fallback
...
end program stage1_scan_fallback

! Same fparser2 hole as pointer_init_target, for an array pointer.
! integer, pointer :: p(:) => a  is valid F2003; fparser2 0.2.4 rejects it.

program array_pointer_init
...
end program array_pointer_init

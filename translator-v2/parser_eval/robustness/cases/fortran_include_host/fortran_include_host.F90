! Inverse robustness: Fortran INCLUDE of host-only code.
! Even without OP2 calls in the include, Flang Stage 1 falls back because
! INCLUDE cannot be resolved from the flang-scan temp file.

program fortran_include_host
...
end program fortran_include_host
